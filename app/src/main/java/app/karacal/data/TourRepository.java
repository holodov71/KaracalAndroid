...
public class TourRepository {
    ...
    public TourRepository() {
        tours.add(new Tour(1, R.mipmap.tour_image_example_06,
                ...
                null, 10, 14, "Alexander McQueen", 48.863352, 2.346973));

        tours.add(new Tour(2, R.mipmap.tour_image_example_02,
                "Graph techniques with steph",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 9, 14, "Alexander McQueen", 48.852007, 2.356188));

        tours.add(new Tour(3, R.mipmap.tour_image_example_03,
                "The little secrets of the grand palace",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 5, 14, "Alexander McQueen", 48.846273, 2.333738));

        tours.add(new Tour(4, R.mipmap.tour_image_example_02,
                "The little secrets of the grand palace",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 8, 14,  "Alexander McQueen", 48.842149, 2.281903));

        tours.add(new Tour(5, R.mipmap.tour_image_example_05,
                "Graph techniques with steph",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 7, 14, "Alexander McQueen", 48.870894, 2.418592));

        tours.add(new Tour(6, R.mipmap.tour_image_example_06,
                "The little secrets of the grand palace",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 10, 14, "Alexander McQueen", 48.832326, 2.369280));

        tours.add(new Tour(7, R.mipmap.tour_image_example_03,
                "The little secrets of the grand palace",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 6, 14, "Alexander McQueen", 48.854111, 2.365951));

        tours.add(new Tour(8, R.mipmap.tour_image_example_05,
                "Graph techniques with steph",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 3, 14, "Alexander McQueen", 48.867015, 2.317614));

        tours.add(new Tour(9, R.mipmap.tour_image_example_06,
                "The little secrets of the grand palace",
                "Go on a date with the city of light and explore the shores of its main artery in the sunset.",
                null, 9, 14, "Alexander McQueen", 48.832901, 2.388167));

        tours.add(new Tour(10, R.mipmap.tour_image_varda,
                ...
                null, 10, 7, "Orianne MARTY", 48.836139, 2.323694));

        tours.add(new Tour(11, R.mipmap.tour_image_procope,
                "Le Procope",
                ...
                null, 10, 5, "Lydia ALVAREZ", 48.853222, 2.339056));

        tours.add(new Tour(12, R.mipmap.tour_image_jardins_hopital,
                ...
                null, 10, 5, "Fanny COHEN MOREAU", 48.873472, 2.369861));

        tours.add(new Tour(13, R.mipmap.tour_image_bastille,
                "Métro Bastille",
                "Découvrez Paris par ses bouches de métro ! Un audio à écouter sur le quai ou sur la place, en fonction de votre préférence.",
                null, 10, 5, "Hanna FEYLER", 48.853306, 2.369111));

        tours.add(new Tour(14, R.mipmap.tour_image_soulages,
                "Musée Soulages",
                ...
                null, 10, 8, "Hanna FEYLER", 44.351694, 2.568111));

        tours.add(new Tour(15, R.mipmap.tour_image_colonne_de_juillet,
                ...
                null, 10, 3, "Hanna FEYLER", 48.853306, 2.369111));

        tours.add(new Tour(16, R.mipmap.tour_image_orsay,
                ...
                null, 10, 8, "Marie PLAINFOSSE", 48.86075, 2.325306));

        tours.add(new Tour(17, R.mipmap.tour_image_terreaux,
                "La place des Terreaux",
                "Anouck vous propose une courte visite de la Place des Terreaux, l'occasion de découvrir son histoire et son passé.",
                null, 10, 4, "Anouck RECH", 48.86075, 2.325306));

        tours.add(new Tour(18, R.mipmap.tour_image_invaders,
                "Space Invaders",
                ...
                null, 10, 7, "Moa KHOUAS (Trendy)", 48.867861, 2.363972));

        tours.add(new Tour(19, R.mipmap.tour_image_monceau,
                "Le Parc Monceau",
                "Flânez dans le Parc Monceau et découvrez son histoire avec Hanna !",
                null, 10, 4, "Hanna FEYLER", 48.88025, 2.309056));

        tours.add(new Tour(20, R.mipmap.tour_image_stgeor,
                ...
                null, 10, 6, "Clotilde DE BROSSES", 48.879111, 2.337444));

        tours.add(new Tour(21, R.mipmap.tour_image_stravinsky,
                ...
                null, 10, 4, "Jeanne RETACKER", 48.859444, 2.351389));

        tours.add(new Tour(22, R.mipmap.tour_image_cuisine,
                ...
                null, 10, 6, "Jennifer KERNER", 48.860639, 2.337417));

        tours.add(new Tour(23, R.mipmap.tour_image_philippe_pot,
                ...
                null, 10, 11, "Jennifer KERNER", 48.861583, 2.335861));

        tours.add(new Tour(24, R.mipmap.tour_image_mort,
                ...
                null, 10, 9, "Jennifer KERNER", 48.862194, 2.336056));

        tours.add(new Tour(25, R.mipmap.tour_image_vaudou,
                ...
                null, 10, 7, "Jennifer KERNER", 48.86125, 2.298139));

        tours.add(new Tour(26, R.mipmap.tour_image_chteaugaillard,
                "Le Château Gaillard",
                "Découvrez avec moi ce château que j'affectionne tant !",
                null, 10, 5, "Rémi Hamot", 49.238028, 1.403444));

        tours.add(new Tour(27, R.mipmap.tour_image_corps,
                ...
                null, 10, 6, "Jennifer KERNER", 48.851111, 2.313917));

        tours.add(new Tour(28, R.mipmap.tour_image_saint_lambert,
                ...
                null, 10, 6, "Quentin BIDAULT", 48.842611, 2.296694));

        tours.add(new Tour(29, R.mipmap.tour_image_example_03,
                "Les adresses gourmande du XIIIe arrondissement",
                "Culture gourmande au programme !",
                null, 10, 5, "Chloé NGUYEN", 48.851111, 2.313917));

        tours.add(new Tour(30, R.mipmap.tour_image_arnes,
                "Arènes de Lutèce",
                ...
                null, 10, 6, "Hanna FEYLER", 48.845278, 2.352889));

        tours.add(new Tour(31, R.mipmap.tour_image_assemblee_nationale,
                "Assemblée Nationale",
                ...
                null, 10, 4, "Hanna FEYLER", 48.861, 2.318361));

        tours.add(new Tour(32, R.mipmap.tour_image_canal_saint_martin,
                "Canal Saint-Martin",
                ...
                null, 10, 4, "Hanna FEYLER", 48.869306, 2.367083));

        tours.add(new Tour(33, R.mipmap.tour_image_piaf,
                ...
                null, 10, 4, "Charlotte DURAND", 48.8735, 2.38375));

        tours.add(new Tour(34, R.mipmap.tour_image_devient_paris,
                ...
                null, 10, 4, "Charlotte DURAND", 48.854917, 2.3475));

        tours.add(new Tour(35, R.mipmap.tour_image_cernuschi,
                "Musée Cernuschi",
                ...
                null, 10, 5, "Hanna FEYLER", 48.879583, 2.312417));

        tours.add(new Tour(36, R.mipmap.tour_image_grand_palais,
                "Grand Palais",
                ...
                null, 10, 3, "Valentin KERAVEL", 48.866111, 2.313472));

        tours.add(new Tour(37, R.mipmap.tour_image_palais_galliera,
                "Palais Galliera",
                ...
                null, 10, 3, "Maxime PARI", 48.865972, 2.296611));

        tours.add(new Tour(38, R.mipmap.tour_image_arc_de_triomphe,
                "Arc de Triomphe",
                ...
                null, 10, 3, "Maxime PARI", 48.873778, 2.295028));

        tours.add(new Tour(39, R.mipmap.tour_image_louvre,
                "Louvre",
                ...
                null, 10, 4, "Maxime PARI", 48.860611, 2.337611));

        tours.add(new Tour(40, R.mipmap.tour_image_barbier_criminels,
                ...
                null, 10, 4, "Maxime PARI", 48.835944, 2.350194));

        tours.add(new Tour(41, R.mipmap.tour_image_pont_mirebeau,
                "Le Pont Mirabeau ",
                ...
                null, 10, 2, "Valentin KERAVEL", 48.846667, 2.275583));
