...
public class GuideRepository {
    ...
    public GuideRepository(){
        guides.add(new Guide(1, "Zacharie BOUBLI", "Paris", "Historien et guide, Je suis passionné d'histoire. Avec moi, vous découvrirez les annecdotes sombres et croustillantes de Paris, du cimetière Montparnasse au Halles en passant par le Marais. Suivez-moi !", R.mipmap.guide_avatar_1));
